...
public class FindMatrixRowsSorted {
	
	
	
	                 public static int findingHowMuchRowsSortedFromMatrix( int r , int c,  int mat[][]) {
	            ...
	            public static void main(String[] args) {
	                ...
	                int mat[][] = { { 1, 2, 3, 4, 5 },
	                                ...
	                                { 8, 7, 6, 5, 4 },
	                                { 5, 7, 8, 9, 10 } };
	                System.out.print(findingHowMuchRowsSortedFromMatrix(m, n,mat));
